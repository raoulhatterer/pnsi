...
!!! example "{{ exercice() }}"
    === "Énoncé"
        [Exercice 01.1 de la BNS](https://eduscol.education.fr/document/33178/download) pour l'évaluation pratique de l’enseignement de spécialité numérique et sciences informatiques.
